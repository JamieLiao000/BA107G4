...
public class PromotionDAO implements PromotionDAO_interface {
	...
	public List<PromotionVO> getAll() {
		...
		try {
			...
			pstmt = conn.prepareStatement(GET_ALL_ORDERBY_TIME);
			...
			while (rs.next()) {
				...
				promotion.setPmt_sts(rs.getString(5));
				promotion.setPmtpic(rs.getBytes(6));
				promotion.setPmt_s_date(rs.getTimestamp(7));
				promotion.setPmt_e_date(rs.getTimestamp(8));
